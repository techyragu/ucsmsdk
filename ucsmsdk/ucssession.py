...
class UcsSession(object):
    ...
    def unfreeze(path=None):
        ...
        secure = bool(root.attrib['secure'])
        ...
        setattr(handle, '_UcsSession__force', bool(root.attrib['force']))
        setattr(handle, '_UcsSession__auto_refresh',
                bool(root.attrib['auto_refresh']))

        setattr(handle, '_UcsSession__dump_xml', bool(root.attrib['dump_xml']))
        setattr(handle, '_UcsSession__redirect', bool(root.attrib['redirect']))

        if handle._UcsSession__auto_refresh:
